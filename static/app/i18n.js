...
const translations = {
    'zh-CN': {
        ...
        // 'sponsors.runninghubDesc': '<div class="sponsor-runninghub"><div><strong class="sponsor-title">RUNNINGHUB API</strong>通过 API 访问 400+ 顶尖 AI 模型（Seedance、Kling、MiniMax、Nano Banana、Veo 等），享受极具竞争力的超低价格。</div><div class="sponsor-row"><span class="sponsor-tag">高并发支持</span><span class="sponsor-tag">免费 API 测试</span><span class="sponsor-tag">端到端加密</span><a href="https://www.runninghub.ai/call-api?source=github" target="_blank" rel="noopener noreferrer" class="sponsor-btn">免费测试 API (Test the API for Free)</a></div><div>以极具竞争力的底价获取全功能 Seedance API 接入！在线工具约 US$0.031/秒 起，最高降低 60-80% 成本！</div><div class="sponsor-contact">如需 RunningHub 折扣及免费试用，请联系：<a href="mailto:zhenyuedong@haima.me">zhenyuedong@haima.me</a>。</div></div>',
    ...
    'en-US': {
        ...
        // 'sponsors.runninghubDesc': '<div class="sponsor-runninghub"><div><strong class="sponsor-title">RUNNINGHUB API</strong> - Access 400+ leading AI models via API - Seedance, Kling, MiniMax, Nano Banana, Veo, and more - at highly competitive prices.</div><div class="sponsor-row"><span class="sponsor-tag">High-Concurrency Support</span><span class="sponsor-tag">Free API Testing</span><span class="sponsor-tag">End-to-End Encryption</span><a href="https://www.runninghub.ai/call-api?source=github" target="_blank" rel="noopener noreferrer" class="sponsor-btn">Test the API for Free</a></div><div>Get full-powered Seedance API access at rock-bottom prices! Our online tool starts at approximately US$0.031/second—cutting costs by 60-80%!</div><div class="sponsor-contact">For RunningHub discounts and free trials, contact <a href="mailto:zhenyuedong@haima.me">zhenyuedong@haima.me</a>.</div></div>',
